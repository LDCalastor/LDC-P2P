# 🌐 LDC P2P Messenger - Windows Edition

**LDC P2P Messenger** est une solution de communication décentralisée. Grâce à son architecture **Peer-to-Peer (pair à pair)**, vos messages voyagent directement entre vous et vos amis, **sans jamais transiter par un serveur central**.
